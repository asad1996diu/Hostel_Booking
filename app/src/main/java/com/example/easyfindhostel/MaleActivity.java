...
public class MaleActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Male Hostel");

        hostel_name=getResources().getStringArray(R.array.male_hostel_name);
        hostel_address=getResources().getStringArray(R.array.male_hostel_address);
        farmgate_name=getResources().getStringArray(R.array.male_farmgate_name);
        farmagate_address=getResources().getStringArray(R.array.male_farmgate_address);
        uttara_name=getResources().getStringArray(R.array.male_uttara_name);
        uttara_address=getResources().getStringArray(R.array.male_uttara_address);
        mirpur_name=getResources().getStringArray(R.array.male_mirpur_name);
        mirpur_address=getResources().getStringArray(R.array.male_mirpur_address);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(MaleActivity.this,
            ...
            case 0:
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent intent=new Intent(MaleActivity.this,DetailsActivity.class);
